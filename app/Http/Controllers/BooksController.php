...
class BooksController extends Controller
{
    ...
    {
        Excel::create('Data Buku Larampus', function($excel) use ($books) {
            //set property
            $excel->setTitle('Data buku Larampus')
    ...
    public function generateExcelTemplate() 
    {
        Excel::create('Template Import Buku', function($excel) {
            ...
            ->setCreator('Larampus')
            ->setCompany('Larampus')
            ->setDescription('Template Import Buku untuk Larampus');
    ...
    public function importExcel(Request $request) 
    {
        ...
        //baca sheet pertama
        $excel = Excel::selectSheetsByIndex(0)->load($excel, function($reader){
            //option, jika ada
        })->get();
        ...
        foreach ($excel as $row) {
            ...
            //catat id dari buku yang baru dilihat
            array_push($books_id, $book->id);
        }

        // Ambil semua buku yang baru dilihat
